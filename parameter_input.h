...
//========================================================================================
// ParameterInput class and related methods are borrowed from Athena++
// Below starts the initial desciption preamble 
//========================================================================================
...
public:
  ...
  double GetReal(std::string block, std::string name);
  double GetOrAddReal(std::string block, std::string name, double value);
  double SetReal(std::string block, std::string name, double value);
  ...
  void ForwardNextTime(double time);
